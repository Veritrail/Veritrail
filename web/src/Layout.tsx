    ...
    <div className="min-h-screen bg-[#F6F8FB] text-[#111827]">
      ...
      >
        ...
        <nav className="flex-1 px-3 py-7 space-y-1">
          ...
          <NavLink to="/controls" className={navItem}>
            <svg className="h-6 w-6 flex-shrink-0" fill="none" stroke="currentColor" strokeWidth={1.75} viewBox="0 0 24 24">
          ...
          {/* Workspace group: admin/config surfaces, separated from daily workflow */}
          <div className="px-4 pt-6 pb-1.5">
            <div className="border-t border-white/[0.06] pt-5 text-[11px] font-semibold uppercase tracking-wider text-slate-500">
              Workspace
            </div>
          </div>

          {canManageAccounts && (
            <NavLink to="/auditors" className={navItem}>
              <svg className="h-6 w-6 flex-shrink-0" fill="none" stroke="currentColor" strokeWidth={1.75} viewBox="0 0 24 24">
          ...
          {canManageAccounts && (
            <NavLink to="/trust-center" className={navItem}>
              <svg className="h-6 w-6 flex-shrink-0" fill="none" stroke="currentColor" strokeWidth={1.75} viewBox="0 0 24 24">
