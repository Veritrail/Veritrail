      ...
      ? createPortal(
          ...
          >
                  ...
                  return (
                    ...
                    >
                      ...
                      <span className="account-filter-card__text">
                        ...
                        <span className="account-filter-card__id">{accountDisplayId(account)}</span>
                      </span>
                    </button>
                  );
                })
            ...
            <div className="account-filter-menu__footer">
              ...
              <div className="account-filter-menu__footer-actions">
    ...
    <div ref={rootRef} className="account-filter">
      ...
      >
        ...
        <span className="account-filter__text">
          ...
          <span className="account-filter__id">{accountDisplayId(current)}</span>
        </span>
