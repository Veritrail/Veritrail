  ...
  if (failed) {
    return (
      <svg className={cls} viewBox="0 0 48 48" fill="none" aria-hidden>
        <rect x="2" y="2" width="44" height="44" rx="13" fill="#FEF3C7" />
        <path d="M15 13h11l6 6v15a2 2 0 0 1-2 2H15a2 2 0 0 1-2-2V15a2 2 0 0 1 2-2Z" fill="#D97706" />
        <path d="M26 13l6 6h-4.5A1.5 1.5 0 0 1 26 17.5V13Z" fill="#FBBF24" />
        <rect x="17" y="23" width="10" height="2.6" rx="1.3" fill="#FDE68A" />
        <rect x="17" y="28" width="6.5" height="2.6" rx="1.3" fill="#FDE68A" />
        <path
