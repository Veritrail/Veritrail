...
def test_remediation_automation_role_arn_uses_aws_account_id_not_veritrail_uuid():
    ...
    assert arn == "arn:aws:iam::123456789012:role/VeritrailRemediationAutomationRole"
...
def test_remediation_automation_role_arn_from_role_arn_when_account_id_missing():
    acc = MagicMock(spec=AwsAccount)
    acc.account_id = None
    acc.role_arn = "arn:aws:iam::999888777666:role/VeritrailScannerRole"
    arn = remediation_automation_role_arn(acc)
    assert arn == "arn:aws:iam::999888777666:role/VeritrailRemediationAutomationRole"
