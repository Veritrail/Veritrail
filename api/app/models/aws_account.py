...
class AwsAccount(Base):
    ...
    enable_remediation_kms: Mapped[bool] = mapped_column(Boolean, default=False, nullable=False)
    ...
    remediation_kms_deployed: Mapped[bool] = mapped_column(Boolean, default=False, nullable=False)
