...
def send_password_reset_email(*, to: str, reset_url: str) -> bool:
    ...
    <div style="font-family:system-ui,sans-serif;line-height:1.5;color:#18181b;max-width:560px">
      ...
      <p style="margin:0 0 20px">
        <a href="{reset_url}" style="display:inline-block;background:#2563eb;color:#fff;text-decoration:none;
      ...
      <p style="margin:0 0 16px;font-size:12px;word-break:break-all;color:#3f3f46">{reset_url}</p>
